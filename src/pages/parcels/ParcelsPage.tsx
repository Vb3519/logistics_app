        ...
        <div className="w-full flex flex-col gap-4">
          <CustomSection className="hidden w-full h-full items-center gap-4 bg-section_primary sm:flex">
            <div className="h-full flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-semibold text-secondary lg:text-lg">
                  Сборка посылки:
                </h2>
              </div>

              <ul className="w-full h-full flex flex-col gap-2 text-sm lg:text-base lg:gap-4">
                <li className="p-2 bg-element_primary rounded-sm lg:p-4">
          ...
          <CustomSection className="w-full p-2 bg-section_primary container-shadow xs:rounded-md xs:gap-4 lg:min-h-0 lg:h-full">
            <form className="p-2 h-full flex flex-col gap-8">
              <input
                className="p-2 outline-none bg-element_primary rounded-sm"
                type="text"
